...
<footer>
    <div class="row g-0 gap-4" style="background-color: #1B396A;">
        <div class="col-sm text-white p-5">
            ...
            <p>Tecnológico Nacional de México Veracruz<br>
                ...
                Contacto:<br>
                (229) 934 15 00<br>
                web_veracruz@tecnm.mx</p>
            <p class="font-semibold">Tecnológico Nacional de México Campus Veracruz<br>
        ...
        <p style="color: #1B396A">Nancy Daniela Mendez Arpidez, Daniela Castro Rodriguez, Marco Gabriel Cortés Toledo,
    ...
    <div class="row g-0 p-5 text-white" style="background-color: #0E3129;">
        <div class="col-sm-3 px-2">
            <img src="img/logo-gob.svg" alt="Gobierno de México" style="max-width: 90%;">
        </div>
        <div class="col-sm-3 px-2">
            <h5>Enlaces</h5>
            <ul>
                <li>
                    <a href="https://participa.gob.mx" target="_blank" class="text-white text-decoration-none" title="Participa">Participa</a>
                </li>
                <li>
                    <a href="https://www.gob.mx/publicaciones" target="_blank" class="text-white text-decoration-none" title="Publicaciones Oficiales">Publicaciones Oficiales</a>
                </li>
                <li>
                    <a href="http://www.ordenjuridico.gob.mx" target="_blank" class="text-white text-decoration-none" title="Marco Jurídico">Marco Jurídico</a>
                </li>
                <li>
                    <a href="https://consultapublicamx.inai.org.mx/vut-web/" target="_blank" class="text-white text-decoration-none" title="Plataforma Nacional de Transparencia">Plataforma Nacional de Transparencia</a>
                </li>
                <li>
                    <a href="https://alertadores.funcionpublica.gob.mx/" target="_blank" class="text-white text-decoration-none" title="Alerta">Alerta</a>
                </li>
                <li>
                    <a href="https://sidec.funcionpublica.gob.mx" target="_blank" class="text-white text-decoration-none" title="Denuncia">Denuncia</a>
                </li>
            </ul>
        </div>
        <div class="col-sm-3 px-2">
            ...
            <p>Es el portal único de trámites, información y participación ciudadana.
                <a target="_blank" class="text-white text-decoration-none" href="https://www.gob.mx/que-es-gobmx">Leer más</a>
            </p>
            <ul>
                <li><a class="text-white text-decoration-none" href="https://datos.gob.mx">Portal de datos abiertos</a></li>
                <li><a class="text-white text-decoration-none" href="https://www.gob.mx/accesibilidad">Declaración de accesibilidad</a></li>
                <li><a class="text-white text-decoration-none" href="https://www.gob.mx/privacidadintegral">Aviso de privacidad integral</a></li>
                <li><a class="text-white text-decoration-none" href="https://www.gob.mx/privacidadsimplificado">Aviso de privacidad simplificado</a>
                </li>
                <li><a class="text-white text-decoration-none" href="https://www.gob.mx/terminos">Términos y Condiciones</a></li>
                <li><a class="text-white text-decoration-none" href="https://www.gob.mx/terminos#medidas-seguridad-informacion">Política de
                        seguridad</a></li>
                <li><a class="text-white text-decoration-none" href="https://www.gob.mx/sitemap">Mapa de sitio</a></li>
            </ul>
        </div>
        <div class="col-sm-3 px-2">
            <h5><a class="text-white text-decoration-none" href="https://www.gob.mx/tramites/ficha/presentacion-de-quejas-y-denuncias-en-la-sfp/SFP54">Denuncia
                    contra servidores públicos</a></h5>
            <h5>Síguenos en</h5>
            <ul class="d-inline">
                <a class="px-2 text-decoration-none" target="_blank" href="https://www.facebook.com/gobmexico">
                ...
                <a class="px-2 text-decoration-none" target="_blank" href="https://twitter.com/GobiernoMX">
